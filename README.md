...
This is particularly helpful when you use the .NET SDK container publishing feature, you dont have the ability to add bash commands to the base image. To solve this, just use `lancemccarthy/skia-aspnet:9.0` instead of `mcr.microsoft.com/dotnet/aspnet:9.0` for the **ContainerBaseImage** property during the build.
...
`dotnet publish --arch x64 -t:PublishContainer \
    ...
    -p ContainerBaseImage="lancemccarthy/skia-aspnet:9.0" \
